        ...
        <div>
            ...
            <div className='flex flex-col lg:flex-row items-center justify-between px-10 lg:px-30 mb-32 space-y-10 lg:space-y-0'>
                ...
                <div className='w-full lg:w-1/2'>
                    <h1 className='text-h1 font-bold mb-10 text-center lg:text-left max-sm:text-xl'>Contact us</h1>
                    <h2 className='text-h2 font-semibold italic text-secondary text-center lg:text-left max-sm:text-lg'>"Driving Change Together"</h2>
                </div>
            </div>

            <div className='flex justify-center gap-30 bg-blue-50/50 py-10'>
                {socials.map((social) => (
                    <a className="duration-300 rounded-4xl hover:scale-105 hover:shadow-2xl" key={social.name} href={social.href} target='_blank' rel='noopener noreferrer'>
